  ...
  return (
    <Layout>
      <div className="disclaimer">
        ...
        <p>
          By filling out the contact form, you share with us your name, phone
          number, email address, first and last name.
        </p>
        <p>
        ...
        <p>
          {" "}
          If you <strong>consent</strong> to the processing of your data for the
          purpose of browsing our website and filling in the contact form, the
          company shall have a legal basis to process your data based on Article
          6 (1a) of the GDPR.
        </p>
        <p>
          If any process relies on consent as a legal basis, we want to hereby
          inform you about your right to withdraw your consent at any time in
          the future.
        </p>
        ...
        <p>
          If after you opt-in and you change your mind, you can contact us at
          any time at by filling out the contact form on the website and
          indicating your wish to withdraw your consent.{" "}
        </p>
        <h3>
        ...
        <h3>
          <strong> Processing in third countries </strong>
        </h3>
        <p>
        ...
        <ol>
          ...
          <p>
            ...
            contracting parties and in which they undertake to ensure an
        ...
        <p>
          We will also delete your personal data without undue delay if you

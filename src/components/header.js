    ...
    <header className={`headerWrapper px-4  ${position} z-50 w-full  ${scroll ? " bg-white" : "bg-transparent" } `} >
      ...
      >
        ...
        >
          ...
          <Link onClick={props.toggleMenu} to="/#focus"  href="focus" className={link}>
            <span className={span}>Our Focus</span>
          </Link>
          <Link onClick={props.toggleMenu} to="/#portfolio"  href="portfolio" className={link}>
            <span className={span}>Our Portfolio</span>
          </Link>

          <Link onClick={props.toggleMenu} to="/#team"  href="team" className={link}>
            <span className={span}>Our Team</span>
          </Link>

          <Link onClick={props.toggleMenu} to="/#news"   href="news" className={link}>
            <span className={span}>News</span>
          </Link>

          <Link onClick={props.toggleMenu} to="/#contact"  href="contact" className={link}>
